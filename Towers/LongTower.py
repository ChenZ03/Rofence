...
LongTower_images.append(pygame.transform.scale(pygame.image.load(os.path.join("Assets/Stone_tower/LongRange", "LongRange.png")), (150, 150)))
# Load bullet imgs:
for i in range(1, 6):
    Bullet_images.append(pygame.transform.scale(pygame.image.load(os.path.join("Assets/Stone_tower/LongRange","explosion_00" + str(i) + ".png")), (20, 20)))
